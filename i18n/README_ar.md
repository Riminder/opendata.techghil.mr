...
2. [البدء](#البدء)
3. [بناء المشروع](#بناء-المشروع)
4. [هيكل البيانات](#هيكل-البيانات)
5. [إنشاء التصورات](#إنشاء-التصورات)
6. [عينة من مجموعة البيانات](#عينة-من-مجموعة-البيانات)
7. [إرشادات المساهمة](#إرشادات-المساهمة)
8. [إصدار النسخ](#إصدار-النسخ)
9. [إرشادات رسائل الالتزام](#إرشادات-رسائل-الالتزام)
10. [استخدام Docker](#استخدام-docker)
11. [استخدام Makefile](#استخدام-makefile)
12. [الرخصة](#الرخصة)
